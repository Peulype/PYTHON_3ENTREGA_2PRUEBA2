...
from primer_proyecto.views import saludar, saludar_con_fecha, saludar_con_html, saludar_a_usuario
from club_once_estrellas.views import lista_de_actividades
